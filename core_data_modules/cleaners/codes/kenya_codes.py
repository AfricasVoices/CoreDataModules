class KenyaCodes(object):
    ...
    # The data for the kenya wards variables was obtained from the IEBC website. The data was exported from a PDF file containing
    # registered voters per county assembly ward for the 2022 general election to a spreadsheet: https://docs.google.com/spreadsheets/d/1NQEJ7ikjrmqQAI8sJ-SXyoZhvOYftMtY/edit?usp=share_link&ouid=105008405800104279592&rtpof=true&sd=true. 
    ...
    AINAMOI = "ainamoi" # (Shadows constituency name "ainamoi")
    AIRBASE = "airbase"
    AIRPORT = "airport"
    AKACHIU = "akachiu"
    ...
    BABA_DOGO = "baba dogo"
    BAHARI = "bahari"
    BAHATI = "bahati" # (Shadows constituency name "bahati")
    BALAMBALA = "balambala" # (Shadows constituency name "balambala")
    BAMBA = "bamba"
    BAMBURI = "bamburi"
    BANGALE = "bangale"
    BANISSA = "banissa" # (Shadows constituency name "banissa")
    BANJA = "banja"
    BARAGWI = "baragwi"
    BARAKI = "baraki"
    BARTABWA = "bartabwa"
    ...
    BUMULA = "bumula" # (Shadows constituency name "bumula")
    BUNYALA_CENTRAL_BUDALANGI = "bunyala central budalangi"
    BUNYALA_CENTRAL_NAVAKHOLO = "bunyala central navakholo"
    BUNYALA_EAST = "bunyala east"
    BUNYALA_NORTH = "bunyala north"
    BUNYALA_SOUTH = "bunyala south"
    BUNYALA_WEST_BUDALANGI = "bunyala west budalangi"
    BUNYALA_WEST_NAVAKHOLO = "bunyala west navakholo"
    BURAT = "burat"
    BURA_FAFI = "bura fafi"
    ...
    CENTRAL_SAKWA_AWENDO = "central sakwa awendo"
    CENTRAL_SAKWA_BONDO = "central sakwa bondo"
    ...
    CHALA = "chala"
    CHANGAMWE = "changamwe" # (Shadows constituency name "changamwe")
    CHANIA = "chania"
    CHARAGITA = "charagita"
    CHARI = "chari"
    CHASIMBA = "chasimba"
    ...
    CLAY_CITY = "clay city"
    DABASO = "dabaso"
    DADAAB = "dadaab" # (Shadows constituency name "dadaab")
    ...
    EAST_GEM_GEM = "east gem gem"
    EAST_GEM_RANGWE = "east gem rangwe"
    ...
    ELBEN = "elben"
    ELBURGON = "elburgon"
    ELDAS = "eldas" # (Shadows constituency name "eldas")
    ...
    ENDEBESS = "endebess" # (Shadows constituency name "endebess")
    ENDO = "endo"
    ENDUGH = "endugh"
    ENGINEER = "engineer"
    ...
    FAFI = "fafi" # (Shadows constituency name "fafi")
    FAZA = "faza"
    FINO = "fino"
    FLAMINGO = "flamingo"
    ...
    GANZE = "ganze" # (Shadows constituency name "ganze")
    GARASHI = "garashi"
    ...
    GATANGA = "gatanga" # (Shadows constituency name "gatanga")
    GATARAKWA = "gatarakwa"
    GATHANJI = "gathanji"
    GATHARA = "gathara"
    ...
    GETENGA = "getenga"
    GIKONDI = "gikondi"
    GILGIL = "gilgil" # (Shadows constituency name "gilgil")
    GISAMBAI = "gisambai"
    GITARU = "gitaru"
    GITHABAI = "githabai"
    GITHER = "gither"
    ...
    GITHUNGURI = "githunguri" # (Shadows constituency name "githunguri")
    GITHURAI = "githurai"
    GITOTHUA = "gitothua"
    GITUAMBA = "gituamba"
    GITUGI = "gitugi"
    ...
    IGWAMITI = "igwamiti"
    IJARA = "ijara" # (Shadows constituency name "ijara")
    ...
    JILORE = "jilore"
    JOMVU_KUU = "jomvu kuu"
    JUJA = "juja" # (Shadows constituency name "juja")
    JUNDA = "junda"
    JUNJU = "junju"
    ...
    KABATINI = "kabatini"
    KABAZI = "kabazi"
    KABETE = "kabete" # (Shadows constituency name "kabete")
    KABIANGA = "kabianga"
    KABIEMIT = "kabiemit"
    KABIRO = "kabiro"
    KABISAGA = "kabisaga"
    ...
    KAPENGURIA = "kapenguria" # (Shadows constituency name "kapenguria")
    ...
    KARURA = "karura"
    KARURI = "karuri"
    KASARANI = "kasarani" # (Shadows constituency name "kasarani")
    KASEI = "kasei"
    KASEMENI = "kasemeni"
    KASGUNGA = "kasgunga"
    KASIGAU = "kasigau"
    ...
    KIGUCHWA = "kiguchwa"
    KIGUMO = "kigumo" # (Shadows constituency name "kigumo")
    KIHARA = "kihara"
    KIHINGO = "kihingo"
    ...
    KIKUYU = "kikuyu" # (Shadows constituency name "kikuyu")
    ...
    KIMAETI = "kimaeti"
    KIMANA = "kimana"
    KIMILILI = "kimilili" # (Shadows constituency name "kimilili")
    KIMININI = "kiminini" # (Shadows constituency name "kiminini")
    KIMINTET = "kimintet"
    ...
    KINAKOMBA = "kinakomba"
    KINALE = "kinale"
    KINANGO = "kinango" # (Shadows constituency name "kinango")
    KINANIE = "kinanie"
    ...
    KIPIPIRI = "kipipiri" # (Shadows constituency name "kipipiri")
    KIPKAREN = "kipkaren"
    KIPKELION = "kipkelion"
    KIPKENYO = "kipkenyo"
    KIPLOMBE = "kiplombe"
    ...
    KWA = "kwa"
    KWABWAI = "kwabwai"
    KWANZA = "kwanza" # (Shadows constituency name "kwanza")
    KWARE = "kware"
    ...
    LAFEY = "lafey" # (Shadows constituency name "lafey")
    LAGBOGHOL_SOUTH = "lagboghol south"
    LAGSURE = "lagsure"
    LAINI_SABA = "laini saba"
    LAISAMIS = "laisamis" # (Shadows constituency name "laisamis")
    LAKE_VIEW = "lake view"
    LAKE_ZONE = "lake zone"
    ...
    LIBEHIA = "libehia"
    LIBOI = "liboi"
    LIKONI = "likoni" # (Shadows constituency name "likoni")
    LIKUYANI = "likuyani" # (Shadows constituency name "likuyani")
    ...
    LOGO_LOGO = "logo logo"
    LOIMA = "loima" # (Shadows constituency name "loima")
    LOITA = "loita"
    ...
    LUGARI = "lugari" # (Shadows constituency name "lugari")
    LUMAKANDA = "lumakanda"
    ...
    MAENI = "maeni"
    MAGADI = "magadi"
    MAGARINI = "magarini" # (Shadows constituency name "magarini")
    MAGENCHE = "magenche"
    MAGOGONI = "magogoni"
    MAGOMBO = "magombo"
    MAGUMONI = "magumoni"
    ...
    MBOGHONI = "mboghoni"
    MBOLOLO = "mbololo"
    MBOONI = "mbooni" # (Shadows constituency name "mbooni")
    MEGUN = "megun"
    MEKENENE = "mekenene"
    MELELO = "melelo"
    MELILI = "melili"
    ...
    MOGONDO = "mogondo"
    MOGOTIO = "mogotio" # (Shadows constituency name "mogotio")
    MOIBEN = "moiben" # (Shadows constituency name "moiben")
    MOIBEN_KUSERWO = "moiben/kuserwo"
    MOI_S_BRIDGE = "moi's bridge"
    MOLO = "molo" # (Shadows constituency name "molo")
    MONYERERO = "monyerero"
    MOROTHILE = "morothile"
    MOSIRO_KAJIADO_WEST = "mosiro kajiado west"
    MOSIRO_NAROK_EAST = "mosiro narok east"
    MOSOP = "mosop" # (Shadows constituency name "mosop")
    MOTICHO = "moticho"
    MOTOSIET = "motosiet"
    ...
    MWARAKAYA = "mwarakaya"
    MWATATE = "mwatate" # (Shadows constituency name "mwatate")
    MWAVUMBO = "mwavumbo"
    MWAWESA = "mwawesa"
    MWEA = "mwea" # (Shadows constituency name "mwea")
    MWEIGA = "mweiga"
    MWERENI = "mwereni"
    MWIBONA = "mwibona"
    MWIHOKO = "mwihoko"
    ...
    NAMWELA = "namwela"
    NANAAM = "nanaam"
    NANDI_HILLS = "nandi hills" # (Shadows constituency name "nandi hills")
    NANGINA = "nangina"
    NANIGHI = "nanighi"
    NANYUKI = "nanyuki"
    ...
    NJIA = "njia"
    NJIRU = "njiru"
    NJORO = "njoro" # (Shadows constituency name "njoro")
    NJUKIINI = "njukiini"
    ...
    NORTH_GEM = "north gem"
    NORTH_HORR = "north horr" # (Shadows constituency name "north horr")
    ...
    NORTH_SAKWA_AWENDO = "north sakwa awendo"
    NORTH_SAKWA_BONDO = "north sakwa bondo"
    ...
    RONG_E = "rong'e"
    ROYSAMBU = "roysambu" # (Shadows constituency name "roysambu")
    RUAI = "ruai"
    RUCHU = "ruchu"
    RUGI = "rugi"
    RUGURU = "ruguru"
    ...
    SABAKI = "sabaki"
    SABENA = "sabena"
    SABOTI = "saboti" # (Shadows constituency name "saboti")
    SACHO = "sacho"
    SAGALLA = "sagalla"
    SAGAMIAN = "sagamian"
    ...
    SIGOMERE = "sigomere"
    SIGONA = "sigona"
    SIGOR = "sigor" # (Shadows constituency name "sigor")
    SIGOWET = "sigowet"
    SIKHENDU = "sikhendu"
    SILALE = "silale"
    ...
    SOUTH_SAKWA_AWENDO = "south sakwa awendo"
    SOUTH_SAKWA_BONDO = "south sakwa bondo"
    SOUTH_UYOMA = "south uyoma"
    SOUTH_WEST_KISUMU = "south west kisumu"
    SOUTH_WEST_NYAKACH = "south west nyakach"
    SOY = "soy" # (Shadows constituency name "soy")
    SOYSAMBU_MITUA = "soysambu/mitua"
    SOY_NORTH = "soy north"
    SOY_SOUTH = "soy south"
    SUAM = "suam"
    SUBUKIA = "subukia" # (Shadows constituency name "subukia")
    ...
    TAPSAGOI = "tapsagoi"
    TARAKWA = "tarakwa"
    TARBAJ = "tarbaj" # (Shadows constituency name "tarbaj")
    TEBERE = "tebere"
    TEBESONIK = "tebesonik"
    TEMBELIO = "tembelio"
    ...
    THANGATHA = "thangatha"
    THANGE = "thange"
    THARAKA = "tharaka" # (Shadows constituency name "tharaka")
    ...
    TIRIOKO = "tirioko"
    TIWI = "tiwi"
    TONGAREN = "tongaren" # (Shadows constituency name "tongaren")
    TONONOKA = "tononoka"
    ...
    TURKWEL = "turkwel"
    TUWANI = "tuwani"
    UGUNJA = "ugunja" # (Shadows constituency name "ugunja")
    UKIA = "ukia"
    UKUNDA = "ukunda"
    UKWALA = "ukwala"
    UMANDE = "umande"
    ...
    WEST_GEM_GEM = "west gem gem"
    WEST_GEM_RANGWE = "west gem rangwe"
    ...
    WEST_SAKWA_AWENDO = "west sakwa awendo"
    WEST_SAKWA_BONDO = "west sakwa bondo"
