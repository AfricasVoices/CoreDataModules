...
class TestDemographicCleaner(unittest.TestCase):
    ...
    def test_clean_age_range(self):
        self.assertEqual(DemographicCleaner.clean_age_range("45"), 45)
        self.assertEqual(DemographicCleaner.clean_age_range(17), 17)
        self.assertEqual(DemographicCleaner.clean_age_range("4"), Codes.NOT_CODED)
        self.assertEqual(DemographicCleaner.clean_age_range("four"), Codes.NOT_CODED)
        self.assertEqual(DemographicCleaner.clean_age_range("Text not involving a number"), Codes.NOT_CODED)
        self.assertEqual(DemographicCleaner.clean_age_range("10.5"), Codes.NOT_CODED)
        self.assertEqual(DemographicCleaner.clean_age_range("17", min_age_inclusive=20), Codes.NOT_CODED)
        self.assertEqual(DemographicCleaner.clean_age_range("17", max_age_inclusive=15), Codes.NOT_CODED)
